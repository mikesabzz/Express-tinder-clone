...
const seedDb = async () => {
  try {
    ...
    const bio1 = await Bio.create({
      image:
        "https://upload.wikimedia.org/wikipedia/commons/b/b2/Tom_Brady_2017.JPG",
    ...
    const bio2 = await Bio.create({
      image:
        "https://media.vanityfair.com/photos/5e500c6c9f4dd300088c1557/1:1/w_1211,h_1212,c_limit/leonardo-dicaprio-jan-1998-annie-leibovitz.jpg",
